    ...
    return (
        <section id="about">
            <div className="pt-20  w-full h-[60vh] p-4 relative">
                <img src={getImageUrl("37.jpg")} className="w-full h-full object-cover object-center absolute mix-blend-overlay rounded-lg" alt="Ashton Phillips 37" loading=" lazy" />
